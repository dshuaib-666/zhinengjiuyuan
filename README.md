...
===
  ...
  本人负责小车的代码应用层编写及PCB绘制，主体规划方向PDF的编写。 

  仅开源电控部分：遥控器代码+PCB,主控板代码+PCB。
 ...
 *#方便移植的有*<br>
 ...
 2.轮式里程计 与陀螺仪的融合系统<br>
 目前只能做到将x，y分别存放到不同的x，y数组，然后小车会'直线'(水平不足，非曲线路径)前往该地点，当距离该点在一定范围内，则进入下个点的前进<br>
